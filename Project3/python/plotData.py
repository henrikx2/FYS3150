...
plt.plot(legTime,legError,label="guLeg",linewidth="1")
plt.plot(lagTime,lagError,label="guLag",linewidth="1")
plt.plot(mcbfTime,mcbfError,label="MCBF",linewidth="1")
plt.plot(mcisTime,mcisError,label="MCIS",linewidth="1")
plt.legend()
plt.xlabel("Time (s)")
plt.ylabel("Error")
